...
\begin{figure}[h]
    \includegraphics[width=13cm]{{Images/Wave 1.png}}
    \centering
    \caption{This is the simulation of step 1}
\end{figure}

\begin{figure}[h]
    \includegraphics[width=13cm]{{Images/Wave 2.png}}
    \centering
    \caption{This is the simulation of step 2}
\end{figure}

\begin{figure}[h]
    \includegraphics[width=13cm]{{Images/Wave 3.png}}
    \centering
    \caption{This is the simulation of step 3}
\end{figure}

\begin{figure}[h]
    \includegraphics[width=13cm]{{Images/Wave 4.png}}
    \centering
    \caption{This is the simulation of step 4}
\end{figure}

\begin{figure}[h]
    \includegraphics[width=13cm]{{Images/Wave 5.png}}
    \centering
